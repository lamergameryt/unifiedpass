...
def register(
    ...
    if utils.check_user_exists(connection, username.text()):
        utils.show_error(
            "The user with this name already exists! Please register with different username.",
            window,
        )
        return
    ...
    utils.show_message(
        "Your account has been registered. Please proceed to log into your account.",
        window,
    )
    username.setText("")
    password.setText("")
